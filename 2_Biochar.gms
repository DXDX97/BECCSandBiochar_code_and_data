...
* 3626 biomass * 3453 plants * 571 county
...
Sets
       ...
       n   CO2 constraints
       ;
$call gdxxrw D:/dx/landuse/231129/S2/abcparameters_simple.xlsx output=D:/dx/landuse/231129/S2/abcparameters_simple1.gdx set=i rng=A2:A3613 rdim=1 set=m rng=E2:E3454 rdim=1 set=n rng=I2:I3 rdim=1
$GDXIN D:/dx/landuse/231129/S2/abcparameters_simple1.gdx
$load i m n
$GDXIN
;
...
$call gdxxrw D:/dx/landuse/231129/S2/abcparameters_simple.xlsx output=D:/dx/landuse/231129/S2/abcparameters_simple2.gdx par=a rng=A2:B3613 rdim=1 par=r_direct rng=C2:D3613 rdim=1 par=d rng=I2:J3 rdim=1 par=area rng=K2:L3613 rdim=1 par=aratio rng=M2:N3613 rdim=1
$GDXIN D:/dx/landuse/231129/S2/abcparameters_simple2.gdx
...
$call gdxxrw D:/dx/landuse/231129/S2/matrix_biomass_plant.xlsx output=D:/dx/landuse/231129/S2/matrix_biomass_plant.gdx par=d3  rdim=1 cdim=1
$GDXIN D:/dx/landuse/231129/S2/matrix_biomass_plant.gdx
$load d3
$GDXIN
;
