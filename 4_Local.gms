...
$call gdxxrw D:/dx/BECCSBC/Local/abcparameters_simple_ForCropMan.xlsx output=D:/dx/BECCSBC/Local/abcparameters_simple_ForCropMan1.gdx set=i rng=A2:A3613 rdim=1 set=in rng=F2:F1155 rdim=1  set=k rng=H2:H349 rdim=1
$GDXIN D:/dx/BECCSBC/Local/abcparameters_simple_ForCropMan1.gdx


*consider all
*$call gdxxrw D:/dx/BECCSBC/Local/abcparameters_simple.xlsx output=D:/dx/BECCSBC/Local/abcparameters_simple1.gdx set=i rng=A2:A3613 rdim=1 set=in rng=F2:F1164 rdim=1  set=k rng=H2:H349 rdim=1
*$GDXIN D:/dx/BECCSBC/Local/abcparameters_simple1.gdx
$load i in k
$GDXIN
;
...
*       injection..       sum(i,(xna(i)+xa(i))*E_beccs_cap)  =l=  2.29703922252741*1000000000 ;
       carbon..        sum(i, (xna(i)+xa(i))*(E_beccs_cap*0.99-E_beccs_lca-E_beccs_N2O) + (wna(i)+wa(i))*(E_bcs_cap-E_bcs_lca-E_bcs_N2O)) =g= carbonlimit;
